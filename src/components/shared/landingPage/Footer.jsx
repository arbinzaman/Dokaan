...
import dokaan from "../../../assets/Home/logos/DOKAAN_FINAL.png";
    ...
    <Section crosses className="!px-0 !py-10">
      <section className="py-6 dark:text-gray-900">
        <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
          <div className="flex flex-col lg:text-left items-center text-center justify-items-center justify-center">
            <p className="mb-1 text-sm font-medium tracking-widest uppercase dark:text-white">
              আপনার দোকানকে ডিজিটাল করতে আজই ডাউনলোড করুন
            </p>
            <img
              src={dokaan}
              width="250"
              className="items-center text-center justify-items-center justify-center"
              alt="Dokaan Logo"
            />
          </div>
          ...
          <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
            ...
            <button className="inline-flex items-center px-5 py-3 rounded-lg dark:bg-red-600 dark:text-gray-50">
              <svg
                ...
                className="fill-current w-7 h-7 dark:text-gray-50"
              >
                <path d="M0 93.7l183.6-24.7v179.5H0V93.7zM0 418.3l183.6 24.7V263.5H0v154.8zM204.4 67l243.6-32.8v212.1H204.4V67zM448 445l-243.6-32.8V263.5H448V445z" />
              </svg>
              <a
                href="https://drive.google.com/uc?export=download&id=YOUR_WINDOWS_EXE_FILE_ID"
                target="_blank"
                rel="noopener noreferrer"
              >
                <span className="flex flex-col items-start ml-4 leading-none">
                  <span className="mb-1 text-xs">Download for</span>
                  <span className="font-semibold title-font">Windows</span>
                </span>
              </a>
            </button>
          </div>
