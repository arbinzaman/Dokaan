	...
	return (
		...
		>
			<div className='flex justify-between items-center mb-6'>
				<h2 className='text-xl font-semibold text-black dark:text-white'>Product List</h2>
					...
					<tbody className='divide-y divide-gray-700'>
						{filteredProducts.map((product) => (
							...
							>
								...
								<td className='px-6 py-4 whitespace-nowrap text-sm text-black dark:text-white'>{product.stock}</td>
								<td className='px-6 py-4 whitespace-nowrap text-sm text-black dark:text-white'>{product.sales}</td>
								<td className='px-6 py-4 whitespace-nowrap text-sm text-black dark:text-white'>
